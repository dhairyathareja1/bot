...
function deprecatedImage(msg, query, animated, faces, cb) {
...
function imageMe(msg, query, animated, faces, cb) {
    let animatedFlag = typeof animated === "boolean" ? animated : undefined;
    let facesFlag = typeof faces === "boolean" ? faces : undefined;
    let callback = cb;
...
//# sourceMappingURL=google-images.js.map